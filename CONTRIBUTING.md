# Contributing to comfydbg

Thank you for considering contributing to comfydbg!
...
- **Subprocess tests** (`test_cli_subprocess.py`): Test the CLI as a user would run it (`python -m comfydbg`)
...
- Use [GitHub Issues](https://github.com/djdarcy/comfydbg/issues)
- Include the output of `comfydbg --version`
- Include your Windows version (`winver`)
- If possible, include the `--json` output (redact any sensitive hostnames or usernames)

### Suggesting Enhancements

- Check [existing issues](https://github.com/djdarcy/comfydbg/issues) and the [roadmap](https://github.com/djdarcy/comfydbg/issues/3) first
...
Check issues labeled [`good first issue`](https://github.com/djdarcy/comfydbg/labels/good%20first%20issue) for accessible starting points. Other areas:
